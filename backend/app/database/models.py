...
class AIGlobalRules(Base):
    ...
    compass_mode_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class AIGlobalInstructionDocument(Base):
    ...
    content_type: Mapped[Optional[str]] = mapped_column(String(128), default="application/pdf", nullable=True)
