...
- **Action Workflow**:
  ...
  3. **Patient & Helpful Support**: Seamlessly continue your response to the user with warm empathy, exceptional patience, simplified steps, and clear actionable solutions to eliminate their cognitive burden.
"""
